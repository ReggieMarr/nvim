...
vim.keymap.set('n', '<C-a>', '0', { desc = 'move beginning of line' })
...
-- File finding with directory navigation (emacs-like <leader>ff)
local function find_files_with_directory_fallback()
    ...
    attach_mappings = function(prompt_bufnr, map)
      telescope_actions.select_default:replace(function()
        ...
        if selection then
          ...
          -- If no file selected, open file browser in current directory
...
-- File mappings
vim.keymap.set('n', '<leader>ff', find_files_with_directory_fallback, { desc = 'Find file from buffer directory' })
...
-- General mappings
vim.keymap.set('n', '<leader>qq', '<cmd>qa<cr>', { desc = 'Quit Editor', nowait = true })
vim.keymap.set('n', '<leader>fq', '<cmd>qa!<cr>', { desc = 'Force Quit Editor', nowait = true })
vim.keymap.set('n', '<leader>wq', '<cmd>wq<cr>', { desc = 'Write Quit Editor', nowait = true })
vim.keymap.set('n', '<leader>ip', '<cmd>Inspect<cr>', { desc = 'HL Group Under Cursor' })
vim.keymap.set('n', '<leader><leader>', '<cmd>Telescope find_files<CR>', { desc = 'Find file in project' })
...
vim.keymap.set('n', '<M-x>', '<cmd>Telescope keymaps<CR>', { desc = 'Execute command' })
...
vim.keymap.set('n', '<leader>ss', '<cmd>Telescope lsp_document_symbols<CR>', { desc = 'Search symbols in file' })
vim.keymap.set('n', '<leader>sv', '<cmd>Telescope vim_options<CR>', { desc = 'Search vim_options' })
vim.keymap.set('n', '<leader>si', '<cmd>Telescope treesitter<CR>', { desc = 'Search objects (treesitter)' })

-- Project
vim.keymap.set('n', '<leader>pf', '<cmd>Telescope git_files<CR>', { desc = 'Find file in project' })
