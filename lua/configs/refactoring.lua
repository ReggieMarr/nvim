...
M.keys = {
  ...
  -- },
  { "<leader>re", ":Refactor extract<CR>", mode = "n", desc = "Extract To Function" },
  { "<leader>rv", ":Refactor extract_var<CR>", mode = "n", desc = "Extract To Variable" },
  { "<leader>rb", ":Refactor extract_block<CR>", mode = "n", desc = "Extract To Block" },
  { "<leader>rg", ":Refactor extract_block_to_file<CR>", mode = "n", desc = "Extract Block To File" },
  { "<leader>rr", ":Refactor refactor_names<CR>", mode = "n", desc = "Refactor names" },
  { "<leader>rf", ":Refactor extract_to_file<CR>", mode = "n", desc = "Extract to file" },
  { "<leader>ri", ":Refactor inline_var<CR>", mode = "n", desc = "Inline Variable" },
